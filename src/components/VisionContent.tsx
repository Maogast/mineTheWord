...
const goals = [
  {
    ...
    desc: 'Develop cutting-edge Bible study tracks.',
  },
  {
    icon: <PublicIcon />,
    title: 'Global Reach',
    desc: 'Translate courses into multiple languages.',
  },
  {
    icon: <GroupIcon />,
    title: 'Community Hubs',
    desc: 'Launch local learning groups worldwide.',
  },
  {
    icon: <BookIcon />,
    title: 'Digital Library',
    desc: 'Create a free online archive of resources.',
  },
]
